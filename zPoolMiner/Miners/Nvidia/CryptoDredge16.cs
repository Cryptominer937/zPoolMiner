...
{
    public class CryptoDredge16 : Miner
    {
        public CryptoDredge16() : base("CryptoDredge_NVIDIA")
        { }
        ...
        private int count = 0;
        private bool _benchmarkException => MiningSetup.MinerPath == MinerPaths.Data.CryptoDredge16;
        ...
        public override void Start(string url, string btcAddress, string worker)
        {
            ...
            IsApiReadException = MiningSetup.MinerPath == MinerPaths.Data.CryptoDredge16;
            var algo = "";
            var apiBind = "";
