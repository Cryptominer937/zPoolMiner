...
#pragma warning restore IDE1006
        ...
        {
            if (ver.Major == 6 & ver.Minor == 1) return 7;
            else if (ver.Major == 6 & ver.Minor == 2) return 8;
            else return 10;
        }
        ...
        protected double GetNumber(string outdata) => GetNumber(outdata, LookForStart, LookForEnd);
