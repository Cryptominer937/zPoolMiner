...
namespace zPoolMiner
{
    public class DualAlgorithm : Algorithm
    {
        ...
        {
            var zPoolMinerSMA = Globals.NiceHashData;
            if (zPoolMinerSMA == null)
            {
            ...
            var maxProfit = 0d;
            var intensity = -1;
            var paying = zPoolMinerSMA[NiceHashID].paying;
            var secondaryPaying = zPoolMinerSMA[SecondaryNiceHashID].paying;
